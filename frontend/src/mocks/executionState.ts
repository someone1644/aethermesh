...
export const CHECKOUT_EVENTS: RuntimeEvent[] = [
  ...
  event('evt-05', '2026-07-30T09:00:10.500000', 'agent_completed', 'Researcher confidence too low.', { node_id: 'researcher-1', confidence: 0.42, failed: true }),
  event('evt-06', '2026-07-30T09:00:11.000000', 'policy_triggered', 'Researcher confidence 0.42 fell below the 0.6 threshold.', { policy: 'low_confidence_policy' }),
  event('evt-07', '2026-07-30T09:00:11.500000', 'node_replaced', 'Node replaced.', { old_node: 'researcher-1', new_node: 'researcher-2' }),
  event('evt-08', '2026-07-30T09:00:12.000000', 'agent_started', 'Researcher (retry) started.', { node_id: 'researcher-2' }),
  event('evt-09', '2026-07-30T09:00:17.000000', 'agent_completed', 'Researcher (retry) completed.', { node_id: 'researcher-2', confidence: 0.88, sources: 5 }),
  event('evt-10', '2026-07-30T09:00:18.000000', 'agent_started', 'Coder started.', { node_id: 'coder-1' }),
  event('evt-11', '2026-07-30T09:00:24.000000', 'agent_completed', 'Coder completed.', { node_id: 'coder-1', confidence: 0.93 }),
  event('evt-12', '2026-07-30T09:00:24.200000', 'node_added', 'Node added.', { node_id: 'coder-2', name: 'Coder retry (contingency)', agent_type: 'coder' }),
  event('evt-13', '2026-07-30T09:00:25.000000', 'agent_started', 'Reviewer started.', { node_id: 'reviewer-1' }),
  event('evt-14', '2026-07-30T09:00:29.000000', 'agent_completed', 'Reviewer completed.', { node_id: 'reviewer-1', confidence: 0.96 }),
  event('evt-15', '2026-07-30T09:00:29.200000', 'node_removed', 'Contingency retry no longer needed — coder succeeded on the first attempt.', { node_id: 'coder-2' }),
  event('evt-16', '2026-07-30T09:00:30.000000', 'agent_started', 'Evaluator started.', { node_id: 'evaluator-1' }),
  event('evt-17', '2026-07-30T09:00:34.000000', 'agent_completed', 'Evaluator completed.', { node_id: 'evaluator-1', confidence: 0.82 }),
  event('evt-18', '2026-07-30T09:00:34.500000', 'workflow_completed', 'Workflow execution completed.'),
]
